$(document).ready(function () {
    ...
    */
    var ajax_url = {
        ...
        update: '/web/backstage/goods/datum/update',
    ...
    */
     ...
     */
    function initParam() {
        param.goodsId = $(paramId.goodsId).val();
    ...
    function classifyData(data) {
        ...
        initParam();
        $(paramId.classifyId).val(param.tempClassifyId);
    }
