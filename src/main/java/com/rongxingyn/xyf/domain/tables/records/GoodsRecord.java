...
public class GoodsRecord extends UpdatableRecordImpl<GoodsRecord> implements Record8<String, String, Double, String, Integer, Integer, Byte, Integer> {

    private static final long serialVersionUID = 1636887612;
     ...
     */
    @Override
    public Row8<String, String, Double, String, Integer, Integer, Byte, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row8<String, String, Double, String, Integer, Integer, Byte, Integer> valuesRow() {
     ...
     */
    @Override
    public GoodsRecord values(String value1, String value2, Double value3, String value4, Integer value5, Integer value6, Byte value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GoodsRecord(String goodsId, String goodsName, Double goodsPrice, String goodsBrief, Integer goodsRecommend, Integer goodsSerial, Byte goodsIsDel, Integer classifyId) {
        super(Goods.GOODS);
