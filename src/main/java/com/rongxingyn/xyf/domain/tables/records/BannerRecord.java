...
public class BannerRecord extends UpdatableRecordImpl<BannerRecord> implements Record4<String, Integer, String, Byte> {

    private static final long serialVersionUID = -1155721787;
     ...
     */
    @Override
    public BannerRecord values(String value1, Integer value2, String value3, Byte value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BannerRecord(String bannerId, Integer bannerSerial, String bannerUrl, Byte bannerIsHide) {
        super(Banner.BANNER);
