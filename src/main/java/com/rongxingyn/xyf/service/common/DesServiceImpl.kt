...
open class DesServiceImpl : DesService {
    ...
    override fun encrypt(data: String): String {
        val bt = encrypt(data.toByteArray(Charsets.UTF_8), xyfProperties.getSecurity().desDefaultKey!!.toByteArray(Charsets.UTF_8))
    ...
    override fun decrypt(data: String?): String? {
        ...
        val bt = decrypt(buf, xyfProperties.getSecurity().desDefaultKey!!.toByteArray(Charsets.UTF_8))
